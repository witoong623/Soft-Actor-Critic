...
class RoutePlanner():
    def __init__(self, vehicle, buffer_size):
        ...
        # queue of waypoint that follow the previous one
    ...
    def _compute_next_waypoints(self, k=1):
        ...
        for _ in range(k):
            # _waypoints_queue contains tuple of waypoint and road option.
            # use index zero to get waypoint
    ...
    def _get_waypoints(self):
        ...
        self._current_waypoint = self._map.get_waypoint(
            self._vehicle.get_location())
        # target waypoint; use index 0 because it is the first one of queue which should be the next target
